...
;(function( $, plugin ){
    ...
    var InputFile = function ( $target, pluginName ) {
        var _$input = $target,
            _$group = _$input.closest( '.input_btn_wrap, .input_group' ),
            _$label = _$group.find( '.input_file_name' ),
            _$fileLabel = _$input.siblings( 'label' );
        ...
        this.clear = function () {
            ...
            _$fileLabel.removeAttr( 'tabindex' ).off( 'focusin focusout', focusHandler );
        ...
        function initialize () {
            ...
            _$fileLabel.attr( 'tabindex', 0 ).on( 'focusin focusout', focusHandler );
        }

        function focusHandler (e) {
            if ( e.type === 'focusin' ) {
                _$group.addClass( 'focus' );
            } else {
                _$group.removeClass( 'focus' );
            }
        }
