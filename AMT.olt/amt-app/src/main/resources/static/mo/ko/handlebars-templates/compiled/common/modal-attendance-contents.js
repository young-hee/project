...
this["AP"]["handlebars"]["common"]["modal-attendance-contents"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
    return "layer_title";
  ...
  return "            <div class=\"layer_btns\">\n"
    + ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.btnConfirm : depth0),{"name":"if","hash":{},"fn":container.program(14, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.btnCancel : depth0),{"name":"if","hash":{},"fn":container.program(16, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "            </div>\n";
    ...
    return "                    <button class=\"btn_default_modal_confirm close\" type=\"button\">"
