...
this["AP"]["handlebars"]["order"]["order-unit-award-info"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data,blockParams,depths) {
  ...
  return "			<hr class=\"div m25\">\n			<h3 class=\"h_title cont\"><strong>구매특가 or 사은품</strong></h3>\n			<fieldset class=\"form\">\n				<legend class=\"sr_only\">구매특가 및 사은품 선택</legend>\n\n				<div class=\"box_btn_set\">\n"
    ...
    + "				</div>\n\n				<!--/* 구매특가 */-->\n				<ul class=\"freebies_list notFirstPur\">\n"
    ...
    + "				</ul>\n\n				<!--/* 사은품 */-->\n				<ul class=\"freebies_list notFirstPur\" style=\"display:none\">\n"
    ...
    + "				</ul>\n\n				<div class=\"order_btns\"> <!-- 디폴트 히든값 / 라디오버튼 선택 시 버튼 활성화 -->\n					<button type=\"button\" class=\"btn_sm2_neutral\">선택 취소</button>\n				</div>\n\n			</fieldset>\n";
