...
this["AP"]["handlebars"]["my"]["my-inquiry-list"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data,blockParams,depths) {
  ...
  return "					<dl>\n						<dt>\n							<button type=\"button\" onclick=\"getCont("
    ...
    + "								</span>\n"
    + ((stack1 = (helpers.xif || (depth0 && depth0.xif) || alias4).call(alias3,(depths[1] != null ? depths[1].YN : depths[1]),"==","N",{"name":"xif","hash":{},"fn":container.program(7, data, 0, blockParams, depths),"inverse":container.program(9, data, 0, blockParams, depths),"data":data})) != null ? stack1 : "")
    + "							</span>\n						</dt>\n						<dd id=\"cont_"
    + alias2(alias1((depth0 != null ? depth0.customerInquirySn : depth0), depth0))
    + "\">\n\n						</dd>\n					</dl>\n";
  ...
  return "										<small>결과알림 : <span class=\"color_black\">"
    ...
    return "										<button type=\"button\" class=\"btn_gray_round\">상담평가</button>\n";
},"7":function(container,depth0,helpers,partials,data) {
    return "									<span class=\"status unread\"><i class=\"ico_check\"></i> 미확인</span>\n";
},"9":function(container,depth0,helpers,partials,data) {
    return "									<span class=\"status\"><i class=\"ico_check\"></i> 답변완료</span>\n";
  ...
  return "<dl>\n	<dt><b class=\"title\">"
    ...
    + ((stack1 = (helpers.xif || (depth0 && depth0.xif) || alias2).call(alias1,(depth0 != null ? depth0.totalCount : depth0),">",0,{"name":"xif","hash":{},"fn":container.program(1, data, 0, blockParams, depths),"inverse":container.program(11, data, 0, blockParams, depths),"data":data})) != null ? stack1 : "")
    + "</dl>";
