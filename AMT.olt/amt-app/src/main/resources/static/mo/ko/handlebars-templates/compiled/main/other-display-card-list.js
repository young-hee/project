...
this["AP"]["handlebars"]["main"]["other-display-card-list"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data,blockParams,depths) {
    var stack1;

  return ((stack1 = (helpers.xif || (depth0 && depth0.xif) || helpers.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}),(data && data.index),">",5,{"name":"xif","hash":{},"fn":container.program(2, data, 0, blockParams, depths),"inverse":container.noop,"data":data})) != null ? stack1 : "");
  ...
  return ((stack1 = (helpers.xif || (depth0 && depth0.xif) || alias2).call(alias1,(depth0 != null ? depth0.displayCardTypeCode : depth0),"==","Basic",{"name":"xif","hash":{},"fn":container.program(3, data, 0, blockParams, depths),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + ((stack1 = (helpers.xif || (depth0 && depth0.xif) || alias2).call(alias1,(depth0 != null ? depth0.displayCardTypeCode : depth0),"==","Event",{"name":"xif","hash":{},"fn":container.program(11, data, 0, blockParams, depths),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + ((stack1 = (helpers.xif || (depth0 && depth0.xif) || alias2).call(alias1,(depth0 != null ? depth0.displayCardTypeCode : depth0),"==","BeautyContents",{"name":"xif","hash":{},"fn":container.program(13, data, 0, blockParams, depths),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + ((stack1 = (helpers.xif || (depth0 && depth0.xif) || alias2).call(alias1,(depth0 != null ? depth0.displayCardTypeCode : depth0),"==","BeautyVideo",{"name":"xif","hash":{},"fn":container.program(17, data, 0, blockParams, depths),"inverse":container.noop,"data":data})) != null ? stack1 : "");
  ...
  return "			<div class=\"section m_basic\">\n				<a href=\"javascript:;\">\n					<span class=\"lazy_load_wrap\">\n						<img src=\""
    ...
    + "</span></p>\n						<!-- 상품 정보 -->\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.prodList : depth0),{"name":"each","hash":{},"fn":container.program(4, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
  ...
  return "							<span class=\"product_info_new\">\n								<span class=\"prd_name\">"
    ...
    + ((stack1 = (helpers.xif || (depth0 && depth0.xif) || alias4).call(alias3,((stack1 = (depth0 != null ? depth0.onlineProdPriceSummary : depth0)) != null ? stack1.maxFinalDiscountRate : stack1),">",0,{"name":"xif","hash":{},"fn":container.program(5, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "										<strong class=\"price\">"
    ...
    + "<em>원</em>"
    + ((stack1 = (helpers.xif || (depth0 && depth0.xif) || alias4).call(alias3,((stack1 = (depth0 != null ? depth0.onlineProdPriceSummary : depth0)) != null ? stack1.minOnlineSalePrice : stack1),"!=",((stack1 = (depth0 != null ? depth0.onlineProdPriceSummary : depth0)) != null ? stack1.maxOnlineSalePrice : stack1),{"name":"xif","hash":{},"fn":container.program(7, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "</strong>\n"
    + ((stack1 = (helpers.xif || (depth0 && depth0.xif) || alias4).call(alias3,((stack1 = (depth0 != null ? depth0.onlineProdPriceSummary : depth0)) != null ? stack1.doublePriceDisplayYn : stack1),"==","Y",{"name":"xif","hash":{},"fn":container.program(9, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
  ...
  return "			<div class=\"section display_issue\">\n				<a href=\""
    ...
    + "\">\n					<span class=\"lazy_load_wrap\">\n						<img src=\""
    + alias2(alias1((depth0 != null ? depth0.fileUrl : depth0), depth0))
    + "\" alt=\"\" class=\"lazy_load\">\n					</span>\n					<div class=\"banner_info\">\n						<p class=\"copy\" style=\"color:#fff\"><span>"
    + alias2(alias1((depth0 != null ? depth0.title1 : depth0), depth0))
    + "</span><span>"
    + alias2(alias1((depth0 != null ? depth0.title2 : depth0), depth0))
    + "</span></p>\n						<p class=\"text\" style=\"color:#fff\"><span>"
  ...
  return "			<div class=\"section beauty_cont01\">\n				<a href=\""
    ...
    + alias2(alias1((depth0 != null ? depth0.prodGrpTitle : depth0), depth0))
    + "</p>\n					<div class=\"picks_list01\">\n						<ul>\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.prodList : depth0),{"name":"each","hash":{},"fn":container.program(14, data, 0, blockParams, depths),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "						</ul>\n					</div>\n				</div>\n			</div>\n";
  ...
  return "			<div class=\"section m_video_area\">\n				<div class=\"y_video_wrap\">\n					<div class=\"video_wrap\">\n						<iframe class=\"youtube_video ＠video-apply\" width=\"750\" height=\"420\" src=\""
    ...
    + "\">\n					<a href=\"javascript:;\">\n						<div class=\"banner_info\">\n							<p class=\"copy\" style=\"color:"
    + alias2(alias1((depth0 != null ? depth0.titleColorCode : depth0), depth0))
    + "\"><span>"
    + alias2(alias1((depth0 != null ? depth0.title1 : depth0), depth0))
    + "</span><span>"
    + alias2(alias1((depth0 != null ? depth0.title2 : depth0), depth0))
