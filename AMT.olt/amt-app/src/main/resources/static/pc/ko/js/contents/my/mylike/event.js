...
;(function ( $ ) {
	...
	var MyLikeEvent = $B.Class.extend({
		initialize: function ( options ) {
			...
			this._$list = ( options.$targetList ) ? options.$targetList: this._$target.find( '.list_event > ul' );
...
//					});
		...
		_setEvent: function () {
			//set checkbox all
			this._$target.on( 'change', '#checkAllEvent', function (e) {
