...
this["AP"]["handlebars"]["display"]["product-list"]["category-menu-3"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data,blockParams,depths) {
    var stack1;
  ...
  return "						<li style=\"display: none\"><a href=\"/display/category/"
    ...
    return "				<a href=\"#\" class=\"cate_more\">클렌징 전체보기</a>\n";
