...
this["AP"]["handlebars"]["display"]["product-list"]["category-menu-1"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data,blockParams,depths) {
    var stack1;
  ...
  return "			<p><a href=\"/display/category/"
  ...
  return "<h2 class=\"h_title\"><a href=\"/display/category/"
    + alias2(alias1((depth0 != null ? depth0.displayMenuId : depth0), depth0))
    + "?upperMenuId="
    + alias2(alias1((depth0 != null ? depth0.upperMenuId : depth0), depth0))
    + "\">"
