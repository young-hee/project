...
this["AP"]["handlebars"]["display"]["search"]["search-prod-filter"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "						<li><span class=\"check_wrap\"><input type=\"checkbox\" id=\"flag_"
    + alias3((helpers.calc || (depth0 && depth0.calc) || alias2).call(alias1,(data && data.index),"+",1,{"name":"calc","hash":{},"data":data}))
    + "\" data-val-code=\""
  ...
  return ((stack1 = (helpers.xif || (depth0 && depth0.xif) || helpers.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.addAttrCode : depth0),"==","colorgroup",{"name":"xif","hash":{},"fn":container.program(9, data, 0, blockParams, depths),"inverse":container.noop,"data":data})) != null ? stack1 : "");
  ...
  return ((stack1 = (helpers.xif || (depth0 && depth0.xif) || helpers.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.addAttrCode : depth0),"!=","colorgroup",{"name":"xif","hash":{},"fn":container.program(13, data, 0, blockParams, depths),"inverse":container.noop,"data":data})) != null ? stack1 : "");
  ...
  return "<style>\n	.aside_area.filter.search .filter_option input[type=radio]:checked + label {font-weight:700;color:#000;}\n</style>\n	<div class=\"category\">\n		<ul>\n"
    ...
    + "					</ul>\n					<button type=\"button\" class=\"btn_src_more leg_btn\">더보기</button>\n				</dd>\n			</dl>\n			\n			<dl>\n				<dt>쇼핑찬스</dt>\n				<dd>\n					<ul class=\"leg_tgArea\">\n"
    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.flags : depth0),{"name":"each","hash":{},"fn":container.program(6, data, 0, blockParams, depths),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "					</ul>\n				</dd>\n			</dl>\n			\n"
    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.addAttrs : depth0),{"name":"each","hash":{},"fn":container.program(8, data, 0, blockParams, depths),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "			\n"
    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.addAttrs : depth0),{"name":"each","hash":{},"fn":container.program(12, data, 0, blockParams, depths),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "			\n			<dl class=\"price\">\n				<dt data-attr-code=\"price\">가격</dt>\n				<dd>\n					<ul>\n						<li><span><input type=\"radio\" name=\"price\" id=\"price0\" data-min=\"0\" data-max=\"29999\">\n							<label for=\"price0\">3만원미만</label></span></li>\n						<li><span><input type=\"radio\" name=\"price\" id=\"price3\" data-min=\"30000\" data-max=\"49999\">\n							<label for=\"price3\">3~5만원</label></span></li>\n						<li><span><input type=\"radio\" name=\"price\" id=\"price5\" data-min=\"50000\" data-max=\"69999\">\n							<label for=\"price5\">5~7만원</label></span></li>\n						<li><span><input type=\"radio\" name=\"price\" id=\"price7\" data-min=\"70000\" data-max=\"-1\">\n							<label for=\"price7\">7만원</label></span></li>\n					</ul>\n					<div style=\"margin: 5px 0 5px 0\";><span>직접입력</span></div>\n					<div class=\"direct_entry\">\n						<span class=\"input_wrap\"><input type=\"text\" name=\"min\" class=\"min\" data-value=\""
