...
public class CicuemCuAdtInfTcVo {
	/**
	 * 통합고객번호.
	 */
     ...
     * ex:)20171225
     */
    private String fstPtAcmlDt;
    /**
     * 최종포인트적립일자<br>
     * ex:)20171225
     */
    private String lstPtAcmlDt;
    /**
     * 최초구매일자<br>
     * ex:)20171225
     */
     ...
     * 유선식별전화번호.
     */
    private String wireTidn;
    /**
     * 유선국제전화번호.
     */
    private String wireTexn;
    /**
     * 유선끝전화번호.
     */
    private String wireTlsn;
    /**
     * 최종접속일자<br>
     * ex:)20171225
     */
    private String lstCnttDt;
    /**
     * 전사고객등급코드.
     */
	...
	public String getFscrTspFormat() {
		return fscrTspFormat;
	}
	public void setFscrTspFormat(String fscrTspFormat) {
		this.fscrTspFormat = fscrTspFormat;
	}
	...
	public String getLschTspFormat() {
		return lschTspFormat;
	}
	public void setLschTspFormat(String lschTspFormat) {
		this.lschTspFormat = lschTspFormat;
	}
