...
this["AP"]["handlebars"]["my"]["coupon-list"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "			<tr>\n				<td class=\"acquire\">"
    ...
    + "</td>\n				<td class=\"coupon_name\"><div class=\"flag\">"
    ...
    + "\n				</td>\n"
    + ((stack1 = helpers["if"].call(alias1,((stack1 = (depth0 != null ? depth0.availCoupon : depth0)) != null ? stack1.foGuide : stack1),{"name":"if","hash":{},"fn":container.program(3, data, 0),"inverse":container.program(5, data, 0),"data":data})) != null ? stack1 : "")
    + "			</tr>\n";
  ...
  return "			<tr>\n				<td class=\"acquire\">"
    + alias3((helpers.dateFormat || (depth0 && depth0.dateFormat) || alias2).call(alias1,(depth0 != null ? depth0.issueDt : depth0),"YYYY-MM-DD",{"name":"dateFormat","hash":{},"data":data}))
    + "</td>\n				<td class=\"coupon_type\">"
    + ((stack1 = (helpers.couponTypeSwitch || (depth0 && depth0.couponTypeSwitch) || alias2).call(alias1,(depth0 != null ? depth0.expCoupon : depth0),{"name":"couponTypeSwitch","hash":{},"data":data})) != null ? stack1 : "")
    + "</td>\n				<td class=\"coupon_name\">"
    + alias3(container.lambda(((stack1 = (depth0 != null ? depth0.expCoupon : depth0)) != null ? stack1.couponName : stack1), depth0))
    + "</td>\n				<td class=\"coupon_benefit_type\">"
    ...
    + "				</td>\n"
    + ((stack1 = helpers["if"].call(alias1,((stack1 = (depth0 != null ? depth0.expCoupon : depth0)) != null ? stack1.foGuide : stack1),{"name":"if","hash":{},"fn":container.program(14, data, 0),"inverse":container.program(5, data, 0),"data":data})) != null ? stack1 : "")
    + "			</tr>\n";
