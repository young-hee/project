...
this["AP"]["handlebars"]["my"]["order"]["order-detail-payInfo"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = (depth0 != null ? depth0.info : depth0)) != null ? stack1.ordPayCompareList : stack1),{"name":"each","hash":{},"fn":container.program(10, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
  ...
  return "<h3 class=\"h_title sub pdt40\">"
    ...
    + alias3((helpers.condition || (depth0 && depth0.condition) || alias2).call(alias1,(helpers.eq || (depth0 && depth0.eq) || alias2).call(alias1,(depth0 != null ? depth0.step : depth0),"two",{"name":"eq","hash":{},"data":data}),"환불","",{"name":"condition","hash":{},"data":data}))
    + "</span><span>"
    + alias3((helpers.currencyFormatDefault || (depth0 && depth0.currencyFormatDefault) || alias2).call(alias1,((stack1 = (depth0 != null ? depth0.data : depth0)) != null ? stack1.membershipPoint : stack1),"P",{"name":"currencyFormatDefault","hash":{},"data":data}))
    + "</span></li>\n					<li class=\"clear\"><span>쿠션포인트 "
    + alias3((helpers.condition || (depth0 && depth0.condition) || alias2).call(alias1,(helpers.eq || (depth0 && depth0.eq) || alias2).call(alias1,(depth0 != null ? depth0.step : depth0),"two",{"name":"eq","hash":{},"data":data}),"환불","",{"name":"condition","hash":{},"data":data}))
    + "</span><span>"
    + alias3((helpers.currencyFormatDefault || (depth0 && depth0.currencyFormatDefault) || alias2).call(alias1,((stack1 = (depth0 != null ? depth0.data : depth0)) != null ? stack1.cushionPoint : stack1),"P",{"name":"currencyFormatDefault","hash":{},"data":data}))
    + "</span></li>\n					<li class=\"clear\"><span>진주알 교환</span><span>"
    + alias3((helpers.currencyFormatDefault || (depth0 && depth0.currencyFormatDefault) || alias2).call(alias1,((stack1 = (depth0 != null ? depth0.data : depth0)) != null ? stack1.activityPoint : stack1),"알",{"name":"currencyFormatDefault","hash":{},"data":data}))
    ...
    + alias3((helpers.currencyFormatDefault || (depth0 && depth0.currencyFormatDefault) || alias2).call(alias1,((stack1 = (depth0 != null ? depth0.data : depth0)) != null ? stack1.etcPoint : stack1),"P",{"name":"currencyFormatDefault","hash":{},"data":data}))
    ...
    + "</strong><b></b></p>\n			</dt>\n			<dd>\n				"
    + ((stack1 = (helpers.prodPartial || (depth0 && depth0.prodPartial) || alias2).call(alias1,"my.order.detail.amount-payment","payInfo",(depth0 != null ? depth0.payInfo : depth0),"compareList",(depth0 != null ? depth0.compareList : depth0),"step",(depth0 != null ? depth0.step : depth0),{"name":"prodPartial","hash":{},"data":data})) != null ? stack1 : "")
