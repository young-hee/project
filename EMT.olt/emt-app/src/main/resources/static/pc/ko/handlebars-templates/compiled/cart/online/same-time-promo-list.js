...
this["AP"]["handlebars"]["cart"]["online"]["same-time-promo-list"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data,blockParams,depths) {
  ...
  return "	<div class=\"promotion type2\">\n		<div class=\"item_wrap\">\n			<div class=\"item_info\">\n				<div class=\"item_name2\">\n					<div class=\"check_wrap\">\n						<input type=\"checkbox\" name=\"chkBox\" id=\"chkBoxS_"
    ...
    + alias4(((helper = (helper = helpers.index || (data && data.index)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"index","hash":{},"data":data}) : helper)))
    + "\" "
    + ((stack1 = helpers["if"].call(alias1,(helpers.eq || (depth0 && depth0.eq) || alias2).call(alias1,(depth0 != null ? depth0.selectYn : depth0),"NotSelect",{"name":"eq","hash":{},"data":data}),{"name":"if","hash":{},"fn":container.program(2, data, 0, blockParams, depths),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + " "
