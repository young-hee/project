...
this["AP"]["handlebars"]["display"]["product-list"]["item-slide"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data,blockParams,depths) {
  ...
  return "				<li class=\"ix-list-item\">\n"
    + ((stack1 = (helpers.xif || (depth0 && depth0.xif) || helpers.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.membershipExchOnly : depth0),"==","Y",{"name":"xif","hash":{},"fn":container.program(6, data, 0, blockParams, depths),"inverse":container.program(8, data, 0, blockParams, depths),"data":data})) != null ? stack1 : "")
    + "						<img class=\"lazy_load\" src=\"\" data-src=\""
    + alias2(alias1((depth0 != null ? depth0.imgUrl : depth0), depth0))
    + "\" alt=\""
    + alias2(alias1((depths[1] != null ? depths[1].prodName : depths[1]), depth0))
    + "\">\n					</a>\n				</li>\n";
