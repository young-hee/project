...
this["AP"]["handlebars"]["common"]["pixlee-detail-list"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "				<video controls muted poster=\""
  ...
  return "							"
    + ((stack1 = helpers["if"].call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.avatar_url : depth0),{"name":"if","hash":{},"fn":container.program(10, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
