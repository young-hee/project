...
this["AP"]["handlebars"]["order"]["fullpage-coupon-use-nonMemberAvail"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
    var stack1;

  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = (depth0 != null ? depth0.inputCoupon : depth0)) != null ? stack1.list : stack1),{"name":"each","hash":{},"fn":container.program(2, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "	<ul class=\"loading\" id=\"couponApplyLoading\" style=\"min-height: 100px; display: none\">\n		<li></li>\n		<li></li>\n		<li></li>\n	</ul>\n	<div class=\"page_btns\">\n		<button class=\"btn_lg_secondary\" type=\"button\" id=\"b_close\">취소</button>\n		<button class=\"btn_lg_primary\" type=\"button\" id=\"b_download\">적용</button>\n	</div>\n";
  ...
  return "		<div class=\"coupon_order\">\n			<span class=\"check_wrap\">\n				<input type=\"checkbox\" id=\""
    ...
    return "	<div class=\"panel notice\">\n		<i class=\"ico\"></i>\n		<p class=\"text font_lg\"><b>조회된 쿠폰이 없습니다.</b></p>\n		<br>\n		<p class=\"text\">이벤트/행사 정보를 통해 할인 및 다양한 혜택이 담긴<br>\n			쿠폰 이벤트에 해당하는 제품을 주문해보세요.\n		</p>\n		<a href=\"/display/event?displayMenuId=event\" class=\"btn_md_bordered\">다양한 이벤트/행사 보러가기</a>\n	</div>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    var stack1;

  return ((stack1 = (helpers.xif || (depth0 && depth0.xif) || helpers.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = (depth0 != null ? depth0.inputCoupon : depth0)) != null ? stack1.couponCnt : stack1),">",0,{"name":"xif","hash":{},"fn":container.program(1, data, 0),"inverse":container.program(4, data, 0),"data":data})) != null ? stack1 : "");
},"useData":true});