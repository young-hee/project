...
this["AP"]["handlebars"]["my"]["order"]["orderList"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data,blockParams,depths) {
  ...
  return "				<div class=\"table_layout\">\n					<div><img src=\""
    ...
    + alias2(((helper = (helper = helpers.claimTypeCode || (depth0 != null ? depth0.claimTypeCode : depth0)) != null ? helper : alias4),(typeof helper === alias5 ? helper.call(alias3,{"name":"claimTypeCode","hash":{},"data":data}) : helper)))
    + "', '"
    + alias2(((helper = (helper = helpers.ordHistNo || (depth0 != null ? depth0.ordHistNo : depth0)) != null ? helper : alias4),(typeof helper === alias5 ? helper.call(alias3,{"name":"ordHistNo","hash":{},"data":data}) : helper)))
    + "')\">"
    ...
    + "</small></p>\n					</div>\n					<div>\n						<p><em>"
    + alias2((helpers.ordStatusCheck || (depth0 && depth0.ordStatusCheck) || alias4).call(alias3,(depths[1] != null ? depths[1].type : depths[1]),(depth0 != null ? depth0.claimTypeCode : depth0),{"name":"ordStatusCheck","hash":{},"data":data}))
    + "</em></p>\n					</div>\n				</div>\n";
  ...
  return "		<div class=\"panel\">\n			<div class=\"table_layout\">\n				<div>주문번호</div>\n				<div class=\"num\"><a href=\"javascript:;\" onclick=\"showDetailView('"
    ...
    + "			</div>\n"
    + ((stack1 = helpers["if"].call(alias2,(depth0 != null ? depth0.ordProdInfo : depth0),{"name":"if","hash":{},"fn":container.program(8, data, 0, blockParams, depths),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "\n		</div>\n\n";
  ...
  return "				<div class=\"table_layout\">\n					<div><img src=\""
    ...
    + alias2((helpers.dateFormat || (depth0 && depth0.dateFormat) || alias4).call(alias3,(depth0 != null ? depth0.ordReceivedDt : depth0),"YYYY-MM-DD",{"name":"dateFormat","hash":{},"data":data}))
    + "</small></p>\n					</div>\n					<div>\n						<p><em>"
    + alias2((helpers.ordStatusCheck || (depth0 && depth0.ordStatusCheck) || alias4).call(alias3,((stack1 = (depth0 != null ? depth0.onlineOrdProdInfo : depth0)) != null ? stack1.ordHistProdStatusCode : stack1),{"name":"ordStatusCheck","hash":{},"data":data}))
    + "</em></p>\n					</div>\n				</div>\n";
