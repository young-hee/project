...
this["AP"]["handlebars"]["display"]["ch-etude"]["detail-product-list"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data,blockParams,depths) {
  ...
  return "				<li class=\"ix-list-item item\" data-online-prod-sn=\""
    ...
    + "\" alt=\"\" /></div>\n						<div class=\"item_info\">\n							<div>\n"
    + ((stack1 = helpers["if"].call(alias3,(depth0 != null ? depth0.lineDesc : depth0),{"name":"if","hash":{},"fn":container.program(3, data, 0, blockParams, depths),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "								<p class=\"prd_name\">"
  ...
  return "					<li class=\"ix-list-item item\" data-online-prod-sn=\""
    ...
    + "\" alt=\"\" /></div>\n							<div class=\"item_info\">\n								<div>\n"
    + ((stack1 = helpers["if"].call(alias3,(depths[1] != null ? depths[1].lineDesc : depths[1]),{"name":"if","hash":{},"fn":container.program(17, data, 0, blockParams, depths),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "									<p class=\"prd_name\">"
    ...
    return "										<p class=\"s_name\">"
    + container.escapeExpression(container.lambda((depths[1] != null ? depths[1].lineDesc : depths[1]), depth0))
    + "</p>\n";
