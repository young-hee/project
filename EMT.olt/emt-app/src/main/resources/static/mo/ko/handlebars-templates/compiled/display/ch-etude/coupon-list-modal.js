...
this["AP"]["handlebars"]["display"]["ch-etude"]["coupon-list-modal"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "		<p class=\"h_title align_center\">다운로드 가능 쿠폰 총 <em>"
    ...
    + "		</ul>\n		<div class=\"page_btns\">\n			<a href=\"#none\" class=\"btn_md_primary w50p btn_coupon_all_download\">전체 쿠폰 받기</a>\n		</div>\n";
  ...
  return "				<li class=\"clear\">\n					<span>"
    ...
    return "						<button class=\"btn_sm_neutral btn_coupon_download\" type=\"button\" data-coupon-sn=\""
    + container.escapeExpression(container.lambda((depth0 != null ? depth0.couponSn : depth0), depth0))
    + "\">쿠폰다운</button>\n";
},"5":function(container,depth0,helpers,partials,data) {
    return "						<button class=\"btn_sm_neutral btn_coupon_download\" type=\"button\" disabled>다운완료</button>\n";
  ...
  return "<div class=\"ch_etude_coupon_down\">\n"
    + ((stack1 = (helpers.xif || (depth0 && depth0.xif) || helpers.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = (depth0 != null ? depth0.couponList : depth0)) != null ? stack1.length : stack1),">",0,{"name":"xif","hash":{},"fn":container.program(1, data, 0),"inverse":container.program(7, data, 0),"data":data})) != null ? stack1 : "")
    + "</div>";
},"useData":true});