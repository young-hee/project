...
this["AP"]["handlebars"]["cs"]["notice-summary"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
    var stack1;
  ...
  return "        <option value=\""
    + alias4(((helper = (helper = helpers.foNoticeTypeSn || (depth0 != null ? depth0.foNoticeTypeSn : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"foNoticeTypeSn","hash":{},"data":data}) : helper)))
    + "\">"
