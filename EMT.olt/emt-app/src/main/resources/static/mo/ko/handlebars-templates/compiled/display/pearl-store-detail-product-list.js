...
this["AP"]["handlebars"]["display"]["pearl-store-detail-product-list"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data,blockParams,depths) {
  ...
  return "\n			<li class=\"prod\" data-online-prod-sn=\""
    ...
    + "</em>								\n									"
    + ((stack1 = alias1((depths[1] != null ? depths[1].onlineProdName : depths[1]), depth0)) != null ? stack1 : "")
    + "\n								</p>\n							</div>\n"
  ...
  return ((stack1 = (helpers.xif || (depth0 && depth0.xif) || helpers.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}),(depths[1] != null ? depths[1].onlineProdName : depths[1]),"!=",(depth0 != null ? depth0.prodName : depth0),{"name":"xif","hash":{},"fn":container.program(5, data, 0, blockParams, depths),"inverse":container.program(7, data, 0, blockParams, depths),"data":data})) != null ? stack1 : "");
