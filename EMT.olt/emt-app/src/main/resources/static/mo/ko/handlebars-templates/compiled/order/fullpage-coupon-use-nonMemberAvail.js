...
this["AP"]["handlebars"]["order"]["fullpage-coupon-use-nonMemberAvail"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "	<div class=\"\" data-open-type=\"single\">\n		<!--입력한 쿠폰리스트(MyPage참조)-->\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = (depth0 != null ? depth0.inputCoupon : depth0)) != null ? stack1.list : stack1),{"name":"each","hash":{},"fn":container.program(2, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "	</div>\n	<div class=\"page_btns\">\n		<button class=\"btn_lg_secondary\" type=\"button\" id=\"b_close\">취소</button>\n		<button class=\"btn_lg_neutral\" type=\"button\" id=\"b_download\">적용</button>\n	</div>\n";
