...
this["AP"]["handlebars"]["cs"]["cc-faq-list"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
    var stack1;
  ...
  return "		<dl>\n   			<dt>\n   				<span class=\"title\">"
    + container.escapeExpression(((helper = (helper = helpers.inquiryText || (depth0 != null ? depth0.inquiryText : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"inquiryText","hash":{},"data":data}) : helper)))
